...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-box">
            ...
            <div style="background-color: rgba(59, 130, 246, 0.1); border: 1px solid rgba(59, 130, 246, 0.3); color: #1e40af; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; font-size: 0.85rem; line-height: 1.4; text-align: center;">
                This is for the data collection and database setup of Vision Hub. Kindly log in using your work Google account so your information can be properly encoded. Thank you very much for your cooperation.
            </div>
